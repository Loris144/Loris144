...
const ARCHETYPE_PROTAGONIST: Record<string, CardDef['protagonist']> = {
  ...
  // From the curated classic-archetype list (see classic_archetypes.json provided by the user):
  'Magician Girl': 'Yugi',
  'Skilled Magician': 'Yugi',
  ...
  'Wicked God': 'Classic',
  Timaeus: 'Yugi',
  'Legendary Knight': 'Classic',
  'with Eyes of Blue': 'Kaiba',
  'Flame Swordsman': 'Joey',
  'Dark Time Wizard': 'Joey',
  Amazoness: 'Mai',
  Relinquished: 'Pegasus',
  'Eyes Restrict': 'Pegasus',
  Millennium: 'Pegasus',
  "Gravekeeper's": 'Marik',
  Slime: 'Marik',
  'Gate Guardian': 'Classic',
  Sangen: 'Classic',
  'Labyrinth Wall': 'Classic',
  'Spirit Message': 'Bakura',
  'Dark Scorpion': 'Classic',
  Jinzo: 'Classic',
  Gadget: 'Classic',
  'Skull Servant': 'Classic',
  Wight: 'Classic',
  Sphinx: 'Classic',
  Umi: 'Classic',
  'Atlantis, the Dragon City': 'Classic',
  'The Sanctuary in the Sky': 'Classic',
  'Temple of the Kings': 'Marik',
  Daedalus: 'Classic',
  Doriado: 'Classic',
  'Man-Eater Bug': 'Weevil',
  Parasite: 'Weevil',
  Guardian: 'Classic',
  'Horus the Black Flame Dragon': 'Classic',
}
